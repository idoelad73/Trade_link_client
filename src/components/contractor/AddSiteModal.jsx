...
const content = {
  en: {
    ...
    btn:        { create: 'Create Site', creating: 'Creating…', cancel: 'Cancel' },
    errors: {
      name:    'Site name is required.',
      type:    'Site type is required.',
      address: 'Site address is required.',
      trades:  'Please select at least one trade needed.',
      server:  'Failed to create site. Please try again.',
    },
  },
  es: {
    badge:   '🏗️ Nueva Obra',
    ...
    btn:        { create: 'Crear Obra', creating: 'Creando…', cancel: 'Cancelar' },
    errors: {
      name:    'El nombre de la obra es obligatorio.',
      type:    'El tipo de obra es obligatorio.',
      address: 'La dirección de la obra es obligatoria.',
      trades:  'Selecciona al menos un oficio necesario.',
      server:  'Error al crear la obra. Inténtalo de nuevo.',
    },
  },
};
