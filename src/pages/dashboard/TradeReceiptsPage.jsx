                  ...
                  <div className="flex-1 p-5">
                    ...
                    <div className="flex items-start justify-between gap-3 flex-wrap">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs font-bold text-slate-600 truncate mt-0.5">🏗️ {r.contractor_name ?? '—'}{r.site_address ? <span className="font-normal text-slate-400"> · {r.site_address}</span> : ''}</p>
                      </div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      ...
                      <div className="flex items-center gap-1.5 bg-slate-50 rounded-lg px-2.5 py-1">
                        <span className="text-xs text-slate-400 line-through">${r.order_sum ?? 0}</span>
                        <span className="text-xs text-red-400 font-medium">−${r.fee_sum ?? 0}</span>
                      </div>
                      <div className="flex items-center gap-1 bg-sky-50 border border-sky-100 rounded-lg px-2.5 py-1 ml-auto">
                        <span className="text-xs text-slate-500">Payout</span>
                        <span className="text-sm font-extrabold text-sky-600">${r.payment_sum ?? 0}</span>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex gap-2 justify-end">
                      ...
                      <button onClick={() => generatePDF(r)} className="flex items-center gap-1.5 text-xs font-semibold px-4 py-2 rounded-xl bg-gradient-to-r from-sky-500 to-indigo-500 text-white hover:opacity-90 shadow shadow-sky-100 transition active:scale-95">
                        ⬇️ {t.download}
                      </button>
                    </div>
                  </div>
