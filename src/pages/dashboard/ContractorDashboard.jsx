...
const content = {
  en: {
    ...
    allSites: {
      title:    'All Sites',
      subtitle: (n) => `${n} site${n !== 1 ? 's' : ''} registered`,
      addBtn:   'Add Site',
      empty:    { title: 'No sites yet', desc: 'Add your first construction site to get started.', btn: 'Add Your First Site' },
    },
    schedule: { title: 'Sites Schedule', desc: 'Schedule management coming soon.' },
    status:   { active: 'active', completed: 'completed', on_hold: 'on hold' },
    findTrade: {
      tradesLabel: 'Trades Needed',
      findBtn:     'Find',
      within:      'within',
      radius:      { title: 'Search Radius', desc: 'Maximum distance from your sites' },
    },
    results: {
      title:      (trade, site) => `${trade} professionals near "${site}"`,
  ...
  es: {
    tabs: {
      ...
      addSite:  'Agregar Obra',
      allSites: 'Todas las Obras',
      schedule: 'Calendario de Obras',
    },
    role:   'Contratista',
    logOut: 'Cerrar Sesión',
    allSites: {
      title:    'Todas las Obras',
      subtitle: (n) => `${n} obra${n !== 1 ? 's' : ''} registrada${n !== 1 ? 's' : ''}`,
      addBtn:   'Agregar Obra',
      empty:    { title: 'Sin obras aún', desc: 'Agrega tu primera obra de construcción para comenzar.', btn: 'Agregar Primera Obra' },
    },
    schedule: { title: 'Calendario de Obras', desc: 'Gestión de calendario próximamente.' },
    status:   { active: 'activo', completed: 'completado', on_hold: 'en pausa' },
    findTrade: {
      tradesLabel: 'Oficios Necesarios',
      findBtn:     'Buscar',
      within:      'en',
      radius:      { title: 'Radio de Búsqueda', desc: 'Distancia máxima desde tus obras' },
    },
    results: {
      title:      (trade, site) => `Profesionales de ${trade} cerca de "${site}"`,
